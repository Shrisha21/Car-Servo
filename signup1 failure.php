  ...
  <div class="login-form">
      <form action="signup.php" method="POST">
		...
		<div class="form-group">
            <input type="text" class="form-control" placeholder="Username" required="required" name="Full_Name" pattern="[a-zA-Z]+" required title="Wrong Name">
        </div>
		<div class="form-group">
            <input type="text" class="form-control" placeholder="Email" required="required" name="Email" pattern="[a-z0-9]+@[a-z0-9]+\.[a-z]{2,3}$" required title="Wrong type of mail">
        </div>
        <div class="form-group">
            <input type="password" class="form-control" placeholder="Password" required="required" name="Password" pattern=".{6,}" required title="6 Charcters minimum">
        </div>
		<div class="form-group">
