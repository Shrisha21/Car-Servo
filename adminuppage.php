    ...
    <p>Customer Page Spares</p>
		    ...
		    <div class="container" style="width:700px;">  
				...
				<br>
                     ...
                     <form  action="adminupitem.php" method="post">  
                          <div style="border:1px; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                               ...
                               <h4 class="text-danger">Old price Rs. <?php echo $row["price"]; ?></h4>  
                               <input type="number" name="quantity" class="form-control" min="1" placeholder="quantity"/> 
							   <input type="number" name="price" class="form-control" min="1" placeholder="Updated Price"/> 
                               <input type="hidden" name="name" value="<?php echo $row["name"]; ?>" />  
                               <input type="hidden" name="h" value="<?php echo $row["price"]; ?>" />  
                               <input type="submit" name="delete" style="margin-top:5px;" class="button" value="UPDATE" />  
                          </div>  
